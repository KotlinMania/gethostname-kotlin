...
This file is the quick-reference operating contract for gethostname-kotlin. The longer
...
gethostname-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`gethostname`](https://crates.io/crates/gethostname). Upstream Rust is the behavioral oracle while the
