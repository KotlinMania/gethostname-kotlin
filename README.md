# Gethostname in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fgethostname--kotlin-blue.svg)](https://github.com/KotlinMania/gethostname-kotlin)
...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`gethostname`](https://crates.io/crates/gethostname).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `gethostname` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

Cross-platform `gethostname()`
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:gethostname-kotlin:0.1.0-SNAPSHOT")
}
```
...
Original work copyrighted by the upstream `gethostname` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
