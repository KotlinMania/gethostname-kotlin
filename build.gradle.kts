...
val androidCompileSdk = projectCompileSdk.toInt()
...
kotlin {
    ...
    val xcf = XCFramework("Gethostname")
    ...
    swiftExport {
        moduleName = "Gethostname"
        flattenPackage = "io.github.kotlinmania.gethostname"
    }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "gethostname-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/gethostname-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/gethostname-kotlin.git")
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        val androidJar = projectAndroidSdkDir
            .resolve("platforms/android-$projectCompileSdk/android.jar")
            .takeIf { it.exists() }
            ?: throw GradleException(
                "codeqlCompileJvm requires Android platform android-$projectCompileSdk; " +
                    "run ./gradlew setupAndroidSdk",
            )
        val fullClasspath =
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.gethostname.codeql
